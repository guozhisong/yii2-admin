        ...
        if ($this->hasModel()) {
            switch ($this->editorType) {
                ...
                case 'file-manager':
                    ...
                    break;
                case 'image-dialog':
                    return Html::activeInput('text', $this->model, $this->attribute, ['id' => $this->id]) . '<input type="button" id="'.$this->id.'Btn" value="选择图片" />';
            ...
            switch ($this->editorType) {
                ...
                case 'file-manager':
                    ...
                    break;
                case 'image-dialog':
                    return Html::input('text', $this->id, $this->value, ['id' => $this->id]) . '<input type="button" class="{$this->id]}Btn" value="选择图片" />';
                    break;
                case 'file-dialog':
